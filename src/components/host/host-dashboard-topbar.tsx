        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="ml-2 flex items-center gap-3 rounded-full border border-black/10 bg-white px-2 py-1.5">
            <div className="text-right leading-tight">
              <div className="text-xs font-semibold">Alexander Thorne</div>
              <div className="text-[10px] font-semibold tracking-wide text-black/35">SUPERHOST</div>
            </div>
            <Avatar name="Alexander Thorne" />
          </div>
        </div>
      </div>
    </header>
